...
var $author$project$WIP$mainText = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Font$typeface('Josefin Slab'),
					$mdgriffith$elm_ui$Element$Font$serif
				]))
		]),
	$mdgriffith$elm_ui$Element$text('Site under construction (literally)'));
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$personDigging = $lattyware$elm_fontawesome$FontAwesome$present($lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$personDigging);
...
var $author$project$WIP$workIcon = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$centerY,
			...
			A3($mdgriffith$elm_ui$Element$rgb255, 250, 108, 48))
		]),
	$mdgriffith$elm_ui$Element$html(
		$lattyware$elm_fontawesome$FontAwesome$view($lattyware$elm_fontawesome$FontAwesome$Solid$personDigging)));
var $author$project$WIP$workInProgress = A2(
	...
	_List_fromArray(
		[$author$project$WIP$workIcon, $author$project$WIP$mainText]));
var $author$project$Main$view = function (model) {
	return {
		body: _List_fromArray(
			[
				$lattyware$elm_fontawesome$FontAwesome$Styles$css,
				A2($mdgriffith$elm_ui$Element$layout, _List_Nil, $author$project$WIP$workInProgress)
			]),
